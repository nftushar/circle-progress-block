...
Tags: block, circle progress, circle, progress, Gutenberg block
...
**[Demos](https://bblockswp.com/demo/circle-progress/)**
...
= How to use =
- First, install the circle-progress plugin
- Add the circle-progress block from the block category called "Widgets" in the Gutenberg editor.
...
2. Search For **circle-progress**
3. Click on the **circle-progress** to add the block

= Download & Upload: =
1. Download the **circle-progress** plugin (*.zip file*)
2. In your admin area, go to the Plugins menu and click on **Add New**
3. Click on **Upload Plugin** and choose the **`circle-progress.zip`** file and click on **Install Now**
4. Activate the plugin and Enjoy!

= Manually: =
1. Download and upload the **circle-progress** plugin to the **`/wp-content/plugins/`** directory
2. Activate the plugin through the Plugins menu in WordPress


== Frequently Asked Questions ==

= Is circle-progress free? =

Yes, circle-progress is a free Gutenberg block plugin.
...
You can post your questions on the [support forum here](https://wordpress.org/support/plugin/circle-progress/)
